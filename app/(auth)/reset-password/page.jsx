    ...
    return (
      <div className="min-h-screen bg-ivory flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          <p className="text-[13px] text-ebony-light mb-6">This reset link is invalid. Please request a new one.</p>
          <Link href="/forgot-password" className="btn-primary text-[10px]">Request New Link</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-ivory flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <h1 className="font-serif text-3xl text-ebony tracking-[2px] mb-4">Password Updated</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          <div className="mb-10">
            ...
            <h1 className="font-serif text-3xl text-ebony tracking-[2px]">Set New Password</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="text-[10px] tracking-[2px] uppercase text-ebony-light mb-2 block">New Password</label>
          ...
          <p className="text-center text-[12px] text-ebony-light mt-8">
            <Link href="/login" className="text-ebony hover:text-gold transition-colors font-medium">Back to Sign In</Link>
          </p>
        </div>
      </div>
    </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-ivory flex items-center justify-center"><Loader2 size={24} className="animate-spin text-gold" /></div>}>
      <ResetForm />
    </Suspense>
  );
}
